            ...
            nodeType.prototype.onNodeCreated = function () {
                ...
                function renderGallery() {
                    ...
                    if (currentItems.length === 0 && !parentDirectory) {
                        cardHolder.innerHTML = '<div style="text-align: center; padding: 20px; color: var(--fg-color);">No items found</div>';
                        return;
                    }
                ...
                function renderPagination() {
                    ...
                    const createButton = (text, page) => {
                        ...
                        btn.style.cssText = 'background: var(--comfy-input-bg); color: var(--fg-color); border: 1px solid var(--input-border-color); padding: 1px 6px; cursor: pointer; font-size: 11px;';
                        if (page === currentPage) {
