...
import { applyFulletSelection, buildFulletCopyText, getPromptWidget, thumbUrl, thumbUrlPair } from "./utils.js";
...
export const Browser = (() => {
    ...
    function _card(artist) {
        const { primary: url, fallback: fallbackUrl } = thumbUrlPair(artist, false);
