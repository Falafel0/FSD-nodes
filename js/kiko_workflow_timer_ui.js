...
class SketchColorPicker {
    ...
    createElements() {
        ...
        this.popup.style.cssText = `
            ...
            background: var(--comfy-input-bg); border-radius: 6px;
        ...
        this.satBrightPointer.style.cssText = `
            ...
            border: 2px solid var(--fg-color); box-shadow: 0 0 0 1px rgba(0,0,0,.3), 0 2px 4px rgba(0,0,0,.3);
        ...
        this.hexInput.style.cssText = `
            flex: 1; padding: 6px 8px; border: 1px solid var(--input-border-color);
            border-radius: 4px; font-size: 13px; font-family: monospace;
            text-transform: uppercase; background: var(--comfy-input-bg); color: var(--fg-color);
        `;
        this.hexInput.addEventListener('change', () => this.setHex(this.hexInput.value));

        const hexLabel = document.createElement('span');
        hexLabel.textContent = 'Hex';
        hexLabel.style.cssText = 'font-size: 12px; color: var(--fg-color); min-width: 28px;';
        ...
        this.presetsContainer.style.cssText = `
            ...
            border-top: 1px solid var(--input-border-color); padding-top: 12px;
        `;
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name === "KikoWorkflowTimer") {
            ...
            nodeType.prototype.onNodeCreated = function() {
                ...
                this.bgcolor = "var(--comfy-menu-bg)";
                this.color = "var(--comfy-input-bg)";
