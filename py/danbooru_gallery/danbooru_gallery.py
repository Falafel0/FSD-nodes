...
def load_autocomplete_config():
    ...
    config_paths = [
        ...
        Path(PLUGIN_DIR).parent.parent / "config.json",
    ]
...
class TagTranslationSystem:
    ...
    def load_translation_data(self):
        ...
        try:
            zh_cn_dir = os.path.join(PLUGIN_DIR, "..", "..", "data", "zh_cn")
...
async def get_user_auth_route(request):
    ...
    try:
        ...
        return web.json_response({"success": True, "username": username, "has_auth": has_auth})
    except Exception as e:
...
class DanbooruGalleryNode:
    ...
    RETURN_NAMES = ("images", "prompts", "tags_by_category", "metadata")
    ...
    def get_selected_data(self, selection_data="{}", **kwargs):
        ...
        try:
            ...
            for sel in selections:
                ...
                # tags_by_category
                tbc = sel.get("tags_by_category", {})
                tags_by_category_list.append(json.dumps({
                    "general": tbc.get("general", ""),
                    "artist": tbc.get("artist", ""),
                    "copyright": tbc.get("copyright", ""),
                    "character": tbc.get("character", ""),
                    "meta": tbc.get("meta", ""),
                }))
                ...
                meta = {
                    ...
                    "post_url": sel.get("post_url", ""),
                    "rating": sel.get("rating", ""),
                    "score": sel.get("score", 0),
                    "fav_count": sel.get("fav_count", 0),
                    "created_at": sel.get("created_at", ""),
                    "image_width": sel.get("image_width", 0),
                    "image_height": sel.get("image_height", 0),
        ...
        return (images, prompts, tags_by_category_list, metadata_list)
...
def get_node_display_name_mappings():
    return {
        "DanbooruGalleryNode": "Danbooru Gallery"
    }
